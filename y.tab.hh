...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TK_VAR = 263,                  // TK_VAR
    TK_CAST = 264,                 // TK_CAST
    TK_SBLOCK = 265,               // TK_SBLOCK
    TK_EBLOCK = 266,               // TK_EBLOCK
    TK_IF = 267,                   // TK_IF
    TK_ELSE = 268,                 // TK_ELSE
    TK_CASE = 269,                 // TK_CASE
    TK_SWITCH = 270,               // TK_SWITCH
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_TK_VAR = 8,                            // TK_VAR
        S_TK_CAST = 9,                           // TK_CAST
        S_TK_SBLOCK = 10,                        // TK_SBLOCK
        S_TK_EBLOCK = 11,                        // TK_EBLOCK
        S_TK_IF = 12,                            // TK_IF
        S_TK_ELSE = 13,                          // TK_ELSE
        S_TK_CASE = 14,                          // TK_CASE
        S_TK_SWITCH = 15,                        // TK_SWITCH
        S_TK_DEFAULT = 16,                       // TK_DEFAULT
        S_TK_ID = 17,                            // TK_ID
        S_OP_ADD = 18,                           // OP_ADD
        S_OP_MINUS = 19,                         // OP_MINUS
        S_OP_MULT = 20,                          // OP_MULT
        S_OP_DIV = 21,                           // OP_DIV
        S_OP_MOD = 22,                           // OP_MOD
        S_OP_EQ = 23,                            // OP_EQ
        S_OP_NE = 24,                            // OP_NE
